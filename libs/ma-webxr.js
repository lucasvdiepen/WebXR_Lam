...
class Controls {
    ...
    getPosition(){
        return this.camera.getAttribute("position");
    }
...
class VRElement {
    ...
    setup(parentId = null, shouldAppendToScene = true) {
...
class Primitive extends VRElement {
    constructor(type, parentId = null, url = '') {
        super();
...
class Cube extends Primitive {
    constructor(parentId = null) {
        super('a-box', parentId);
    }
}

class Plane extends Primitive {
    constructor(parentId = null) {
        super('a-plane', parentId);
    }
}

class Cylinder extends Primitive {
    constructor(parentId = null) {
        super('a-cylinder', parentId);
    }
}

class Cone extends Primitive {
    constructor(parentId = null) {
        super('a-cone', parentId);
    }
}

class Sky extends Primitive {
    constructor(url) {
        super('a-sky', null, url);
    }
}

class XRImage extends Primitive {
    constructor(url) {
        super('a-image', null, url);
        if(url === undefined){
            this.setColor('pink');
        }
    }
